                            ...
                            <div class="card-body">
                                <form action="index.php" method="post" class="row" id="formulario">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="ficha" class="form-control" id="ficha"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="ciudad" id="ciudad">
                                                ...
                                                <option value="bucaramanga" <?php if ($ciudad == "bucaramanga")
                                                    echo "selected" ?>>Bucaramanga</option>
                                                <option value="medellin" <?php if ($ciudad == "medellin")
                                                    echo "selected" ?>>
                                                    Medellin</option>
                                                <option value="cali" <?php if ($ciudad == "cali")
                                                    echo "selected" ?>>Cali
                                                </option>
                                                <option value="bogota" <?php if ($ciudad == "bogota")
                                                    echo "selected" ?>>Bogota
                                                </option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="habilidades[]"
                                                    value="html" id="html" <?php if (in_array('html', $habilidades))
                                                    echo "checked" ?>>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="habilidades[]"
                                                    value="css" id="css" <?php if (in_array('css', $habilidades))
                                                    echo "checked" ?>>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="habilidades[]"
                                                    value="javascript" id="javascript" <?php if (in_array('javascript', $habilidades))
                                                    echo "checked" ?>>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="habilidades[]"
                                                    value="php" id="php" <?php if (in_array('php', $habilidades))
                                                    echo "checked" ?>>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="habilidades[]"
                                                    value="java" id="java" <?php if (in_array('java', $habilidades))
                                                    echo "checked" ?>>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="habilidades[]"
                                                    value="sql" id="sql" <?php if (in_array('sql', $habilidades))
                                                    echo "checked" ?>>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="habilidades[]"
                                                    value="uml" id="uml" <?php if (in_array('uml', $habilidades))
                                                    echo "checked" ?>>
